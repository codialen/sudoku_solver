...
def find_next_empty(puzzle):
    # finds the next row, col on the puzzle that's not filled yet --> blank spaces represented by -1
...
def is_valid(puzzle, guess, row, col):
    ...
    # the number must not be repeated in the row, column, or 3x3 square that it appears in
